...
import { User, Calculator, Database, Calendar, Download, Printer, Plus, Activity, Utensils } from 'lucide-react';
        ...
        <div className="printable-area animate-fade-in">
            ...
            <div className="space-y-8">
                {Object.keys(days).map((dayNum) => {
                    ...
                    const totalCal = dayItems.reduce((acc, it) => acc + Number(it.calories || 0), 0);
                    const totalPro = dayItems.reduce((acc, it) => acc + Number(it.protein || 0), 0);
